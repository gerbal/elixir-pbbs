defmodule Utils.Benchmark.Drivers.ComparisonSort do
  def run_benchmark() do
    ...
    impl_map =
      ...
      |> Map.put("parallel;p=#{p};dense_list", fn ->
        PBBS.Sequences.ComparisonSort.Parallel.sample_sort(256, dense_list)
      end)
      |> Map.put("parallel;p=#{p};sparse_list", fn ->
        PBBS.Sequences.ComparisonSort.Parallel.sample_sort(256, sparse_list)
      end)
      |> Map.new()
