  ...
  def run_benchmark() do
    ...
    impl_map =
      Enum.flat_map(plist, fn p ->
        [
          {"parallel;p=#{p};default",
           fn -> PBBS.Geometry.RayCast.Parallel.ray_cast(triangles, rays, p) end}
        ]
      end)
      |> Map.new()
      |> Map.put("serial;default", fn ->
        PBBS.Geometry.RayCast.Sequential.ray_cast(triangles, rays)
      end)
